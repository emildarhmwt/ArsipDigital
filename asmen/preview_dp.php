                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center justify-content-center d-flex align-items-center"
                            ...
                            <div class=" col-lg-4 border d-flex justify-content-center
                                align-items-center"
                                style="border-radius: 10px; height: 48px; width:31%; color:black; margin-right:10px; background-color: #0e4551;">
                            ...
                            <div class=" col-lg-4 d-flex border justify-content-center
                                align-items-center"
                                style="border-radius: 10px; height: 48px; width:31%; color:black; margin-right:10px;">
                                <?php
