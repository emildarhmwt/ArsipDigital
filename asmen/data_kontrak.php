                                ...
                                <div class="table-responsive products-table" data-simplebar>
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            SELECT doc_kontrak.*, user_pks.pks_nama, 
                                            dockajian.dock_status_gm AS status_gm, 
                                            dockajian.dock_status_vp AS status_vp, 
                                            dockajian.dock_status_avp AS status_avp, 
                                            dockajian.dock_status_asmen AS status_asmen,
                                            doc_kak_hps.dockh_status_gm AS kontrak_status_gm, 
                                            doc_kak_hps.dockh_status_vp AS kontrak_status_vp, 
                                            doc_kak_hps.dockh_status_avp AS kontrak_status_avp, 
                                            doc_kak_hps.dockh_status_asmen AS kontrak_status_asmen
                                            FROM doc_kontrak
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        if (!empty($p['dockt_waktu_gm'])) {
                                                            $dock_waktu = date('H:i:s', strtotime($p['dockt_waktu_gm']));
                                                            $tanggal = date('d M Y', strtotime($p['dockt_waktu_gm']));
                                                            echo $dock_waktu . '<br>' . $tanggal;
                                                        } elseif (!empty($p['dockt_waktu_vp'])) {
                                                            $dock_waktu = date('H:i:s', strtotime($p['dockt_waktu_vp']));
                                                            $tanggal = date('d M Y', strtotime($p['dockt_waktu_vp']));
                                                            echo $dock_waktu . '<br>' . $tanggal;
                                                        } elseif (!empty($p['dockt_waktu_avp'])) {
                                                            $dock_waktu = date('H:i:s', strtotime($p['dockt_waktu_avp']));
                                                            $tanggal = date('d M Y', strtotime($p['dockt_waktu_avp']));
                                                            echo $dock_waktu . '<br>' . $tanggal;
                                                        } elseif (!empty($p['dockt_waktu_asmen'])) {
                                                            $dock_waktu_asmen = date('H:i:s', strtotime($p['dockt_waktu_asmen']));
                                                            $tanggal_asmen = date('d M Y', strtotime($p['dockt_waktu_asmen']));
                                                ...
                                                <td>
                                                    <?php
                                                        if (!empty($p['dockt_status_gm'])) {
                                                            echo $p['dockt_status_gm'];
                                                        } elseif (!empty($p['dockt_status_vp']) ) {
                                                            echo $p['dockt_status_vp'];
                                                        } elseif (!empty($p['dockt_status_avp'])) {
                                                            echo $p['dockt_status_avp'];
                                                        } else {
                                                            echo $p['dockt_status_asmen'];
                                                        }
                                                        ?>
                                                </td>
