                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="mb-4 pb-2">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="dashboard_asmen.php"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            ...
                            <div class="collapse" id="pksDropdown">
                                <ul class="nav flex-column ms-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link judul-sidebar" href="data_kak_hps.php"> <i
                                                class="ti ti-corner-down-right fs-6"></i> Doc KAK & HPS</a>
                                    </li>
                                    <li class="nav-item">
