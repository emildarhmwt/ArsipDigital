...
CREATE TABLE `agenda` (
  ...
  `agenda_tanggal` int(11) NOT NULL,
  `agenda_waktu_awal` int(11) NOT NULL,
  `agenda_waktu_akhir` int(11) NOT NULL,
  `agenda_kegiatan` varchar(255) NOT NULL,
  `agenda_deskripsi` varchar(255) NOT NULL,
  `agenda_lokasi` int(11) NOT NULL,
...
CREATE TABLE `agenda_header` (
  ...
  `agendaheader_nama` varchar(255) NOT NULL,
  `agendaheader_lokasi` varchar(255) NOT NULL,
  `agendaheader_tanggal` date NOT NULL,
  `agendaheader_waktuawal` time NOT NULL,
  `agendaheader_waktuakhir` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, 6, '2024-12-02', 'Koordinasi via wa untuk pelaksaan pekerjaan'),
(8, 6, '2024-12-03', 'Awal Pengerjaan'),
(9, 6, '2024-12-04', 'Progress pemasangan AC'),
(10, 7, '2024-12-09', 'Koordinasi via wa untuk pelaksaan pekerjaan'),
(11, 7, '2024-12-10', 'Awal Pengerjaan'),
(12, 7, '2024-12-11', 'Progress pemasangan AC'),
(13, 8, '2024-12-21', 'Koordinasi via wa untuk pelaksaan pekerjaan'),
(14, 8, '2024-12-19', 'Awal Pengerjaan AC');
...
(6, 'Perbaikan', '2024-12-01', 'Perbaikan AC sebanyak 1 unit', 'Perbaikan AC kantor klawas ruang admin', 'Ruang Admin', 'Budi Santosa', 'Budi Santoso', 'Close', '2024-12-05', '934782438_687607012_1451734872_1258905874_Laporan Produksi - 11 Nov 2024 (2) (4) (3).pdf'),
(7, 'Perbaikan', '2024-12-08', 'Perbaikan AC sebanyak 3 unit', 'Perbaikan AC kantor msf ruang admin', 'Ruang Admin', NULL, 'Budi Santoso', 'Close', '2024-12-12', '797119706_Sales.pdf'),
(8, 'Perbaikan', '2024-12-17', 'Perbaikan AC sebanyak 5 unit', 'Perbaikan AC kantor klawas ruang server', 'Ruang Admin', NULL, 'Budi Santoso', 'On Progress', '0000-00-00', NULL),
(10, 'Perbaikan', '2024-12-03', 'Perbaikan AC sebanyak 1 unit', 'Perbaikan AC kantor klawas ruang admin', 'Ruang Admin', NULL, 'Budi Santoso', 'Open', '0000-00-00', NULL);
...
--
ALTER TABLE `agenda_header`
  MODIFY `agendaheader_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `orderme_isi`
  MODIFY `ordermeisi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `order_me`
--
ALTER TABLE `order_me`
  MODIFY `orderme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
