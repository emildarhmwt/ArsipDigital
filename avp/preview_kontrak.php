<td?php session_start(); if (!isset($_SESSION['status']) || $_SESSION['status'] !="avp_login" ) {
    header("location:../login/loginuser.php?alert=belum_login"); exit; } $id=isset($_GET['id']) ? $_GET['id'] : 0; ?>
    <!doctype html>
    <html lang="en">
                                        ...
                                        <div class="modal" id="rejectModal<?php echo $id; ?>"
                                            ...
                                            <div class="modal-content" style="padding: 10px;">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST"
                                                        action="reject_kontrak.php?id=<?php echo $id; ?>">
                                                        <div class="mb-3">
