                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center justify-content-center d-flex align-items-center"
                            ...
                            <div class=" col-lg-4 d-flex justify-content-center border align-items-center"
                                ...
                                <a href="preview_kontrak.php?id=<?php echo $id; ?>" style="color:white;"> Doc Kontrak
                                </a>
                            </div>
                            <?php
                                }
                            ...
                            <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $p['dockt_nama'] ?></td>
                                        <td><?php echo $p['dockt_waktu_asmen'] ?></td>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $p['dockt_nama'] ?></td>
                                        <td><?php echo ($p['dockt_waktu_avp']) ? $p['dockt_waktu_avp'] : '-' ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $p['dockt_nama'] ?></td>
                                        <td><?php echo ($p['dockt_waktu_vp']) ? $p['dockt_waktu_vp'] : '-' ?>
                                        </td>
                                        <td><?php echo !empty($p['vp_nama']) ? $p['vp_nama'] : '-'; ?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $p['dockt_nama'] ?></td>
                                        <td><?php echo ($p['dockt_waktu_gm']) ? $p['dockt_waktu_gm'] : '-' ?>
                                        </td>
                        ...
                        <div class="row d-inline-flex mt-3 text-center justify-content-center">
                            <!-- <a class="btn btn-custom-upload d-inline-flex justify-content-center align-items-center mx-2"
                                ...
                                style="width: auto; padding: 5px 10px;"><i class="ti ti-thumb-up"></i> Approve
                            </a> -->
                            ...
                            <div class="modal" id="approveModal"
                                ...
                                <div class="modal-content" style="padding: 10px;">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="confirm_kontrak.php?id=<?php echo $id; ?>">
                                            <div class="mb-3">
