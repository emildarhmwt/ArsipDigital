...
<body>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="orderme_aksi.php" enctype="multipart/form-data">
                                <div class="banyak-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" class="form-control text-white" name="orderme_tglselesai"
    ...
    function setStatusOpen() {
        document.getElementById('orderme_status').value = "Open";
    }
    </script>
