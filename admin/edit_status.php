...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-5 text-center fs-7 judul-tabel">EDIT STATUS
                        </h5>
                        <?php
                        $id = $_GET['id'];
                        ...
                        <form method="post" action="status_update.php">
                            <div class="banyak-data">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $d['status_id']; ?>">
                                    <input type="text" class="form-control text-white" name="nama" required="required"
                                        value="<?php echo $d['status_nama']; ?>">
                                </div>
                            </div>
    ...
    function goBack() {
        window.location.href = 'data_status.php';
    }
    </script>
