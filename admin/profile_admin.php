                        ...
                        ?>
                            <div class="col-lg-4 col-xlg-3 col-md-5">
                                <div class="card card-preview">
                                    <div class="card-body">
                                        ...
                                        ?>
                                            <h4 class="card-title m-t-10"><a class="cards-hd-dn text-white"
                                                    href="#"><?php echo $s['admin_nama']; ?></a></h4>
                            ...
                            <div class="col-lg-8 col-xlg-9 col-md-7">
                                <div class="card card-preview">
                                    ...
                                    ?>
                                        <form class="form-horizontal form-material mx-2" action="profil_act.php"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control text-white"
                                                        ...
                                                        required="required" value="<?php echo $s['admin_username'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                                <div class="mb-3">
