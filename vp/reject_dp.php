...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($koneksi, "UPDATE doc_kak_hps SET dockh_waktu_vp=NOW(),dockh_vp='$user_id', dockh_status_vp='Rejected (VP)', dockh_alasan_reject='$alasan' WHERE dockh_dock_id='$id'");
