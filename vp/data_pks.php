                                ...
                                <div class="table-responsive products-table" data-simplebar>
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $arsip = mysqli_query($koneksi, "SELECT * FROM doc1,user_pks WHERE doc1_petugas=pks_id AND (status='Confirm(AVP)' OR status='Done' OR status='Rejected(VP)') ORDER BY doc1_id DESC");
                                            while ($p = mysqli_fetch_array($arsip)) {
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
