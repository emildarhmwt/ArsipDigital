...
mysqli_query($koneksi, "UPDATE doc_kak_hps SET dockh_waktu_vp=NOW(),dockh_tujuan_gm='$tujuan_gm',dockh_vp='$user_id', dockh_status_vp='Approved (VP)' WHERE dockh_dock_id='$id'");
