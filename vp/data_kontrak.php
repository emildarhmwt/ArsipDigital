                                ...
                                <div class="table-responsive products-table" data-simplebar>
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            WHERE (doc3_status='Approve(AVP)' OR doc3_status='Approve(VP)' OR doc3_status='Done' OR doc3_status='Rejected(VP)')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($p['doc3_doc2_id'] != $previous_doc1_id) { // Cek jika ID dokumen berbeda 
                                                        ?>
                                                    <?php if ($p['doc3_status'] != 'Approve(GM)' && $p['doc3_status'] != 'Rejected(VP)' && $p['doc3_status'] != 'Rejected(GM)' && $p['doc3_status'] != 'Done') { ?>
