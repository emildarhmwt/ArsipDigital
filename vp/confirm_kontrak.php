...
mysqli_query($koneksi, "UPDATE doc_kontrak SET dockt_waktu_vp=NOW(),dockt_tujuan_gm='$tujuan_gm',dockt_vp='$user_id', dockt_status_vp='Approved (VP)' WHERE dockt_dock_id='$id'");
