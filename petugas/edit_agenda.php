        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-5 text-center fs-7 judul-tabel">EDIT AGENDA RAPAT </h5>
                            <?php
                                $id = $_GET['id'];
                                $data = mysqli_query($koneksi, "SELECT * from agenda where agenda_id='$id'");
                                while ($d = mysqli_fetch_array($data)) {
                                ?>
                            <form method="post" action="agenda_update.php" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select text-white"
                                                    ...
                                                    <option value="Weekly" style="color: black;"
                                                        <?php echo ($d['agenda_kategori'] == 'Weekly') ? 'selected' : ''; ?>>
                                                        Weekly</option>
                                                    <option value="Monthly" style="color: black;"
                                                        <?php echo ($d['agenda_kategori'] == 'Monthly') ? 'selected' : ''; ?>>
                                                        Monthly</option>
                                                    <option value="Yearly" style="color: black;"
                                                        <?php echo ($d['agenda_kategori'] == 'Yearly') ? 'selected' : ''; ?>>
                                                        Yearly</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select text-white"
                                                    ...
                                                    <option value="Open" style="color: black;"
                                                        <?php echo ($d['agenda_status'] == 'Open') ? 'selected' : ''; ?>>
                                                        Open</option>
                                                    <option value="On Progress" style="color: black;"
                                                        <?php echo ($d['agenda_status'] == 'On Progress') ? 'selected' : ''; ?>>
                                                        On Progress</option>
                                                    <option value="Close" style="color: black;"
                                                        <?php echo ($d['agenda_status'] == 'Close') ? 'selected' : ''; ?>>
                                                        Close</option>
                                                </select>
                                            </div>
                                        </div>
