...
<body>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-5 text-center fs-7 judul-tabel">FORM ORDER ME</h5>
                            <form method="post" action="ordermeisi_aksi.php" enctype="multipart/form-data">
                                <div class="banyak-data">
                                    <div class="row">
                                        <div class="row">
                                            <div class="col-lg-6 col-6">
                                                <div class="mb-3">
                                                    <label for="shift" class="form-label"><span
                                                            class="wajib_isi">*</span>
                                                        Tanggal Follow Up</label>
                                                    <input type="date" class="form-control text-white"
                                                        name="ordermeisi_tanggal" placeholder="Input Data"
                                                        id="ordermeisi_tanggal" onchange="setStatusOnProgress()">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control text-white"
                                                        name="ordermeisi_status" id="ordermeisi_status"
                                                        placeholder="Status" value="<?php
                                                        $orderme_id = $_GET['ordermeisi_order_id'];
                                                        $order_query = mysqli_query($koneksi, "SELECT orderme_status FROM order_me WHERE orderme_id='$orderme_id'");
                                                        $order_data = mysqli_fetch_assoc($order_query);
                                                        echo $order_data['orderme_status'];
                                                        ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12 col-12 col-44">
                                                <div class="mb-3">
                                                    <label for="shift" class="form-label">
                                                        <span class="wajib_isi">*</span> Histori Follow Up</label>
                                                    <input type="text" class="form-control text-white"
                                        ...
                                        <input type="hidden" class="form-control text-white" name="ordermeisi_order_id"
                                            placeholder="Input Data" value="<?php
                                            $orderme_id = $_GET['ordermeisi_order_id'];
                                            $order_query = mysqli_query($koneksi, "SELECT orderme_id FROM order_me WHERE orderme_id='$orderme_id'");
                                            $order_data = mysqli_fetch_assoc($order_query);
                                            echo $order_data['orderme_id'];
                                            ?>">
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-custom-eye"><i class="bi bi-send"></i>
                                                Submit</button>
                                            <button type="button" class="btn btn-custom-edit mx-3"
                                                onclick="window.location.href='orderme_isi.php?id=<?php echo $_GET['ordermeisi_order_id']; ?>'"><i
    ...
    function setStatusOnProgress() {
        document.getElementById('ordermeisi_status').value = "On Progress";
    }
    </script>
