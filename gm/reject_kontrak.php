...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($koneksi, "UPDATE doc_kontrak SET dockt_waktu_gm=NOW(),dockt_gm='$user_id', dockt_status_gm='Rejected (GM)', dockt_alasan_reject='$alasan' WHERE dockt_dock_id='$id'");
