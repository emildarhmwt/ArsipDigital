...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($koneksi, "UPDATE doc_kak_hps SET dockh_waktu_gm=NOW(),dockh_gm='$user_id', dockh_status_gm='Rejected (GM)', dockh_alasan_reject='$alasan' WHERE dockh_dock_id='$id'");
